      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex md:order-0">
          ...
          <div className="relative hidden md:block">
            ...
            <input type="text" id="search-navbar" className="w-full text-black block p-2 ps-10 text-sm border border-gray-300 rounded-full bg-white focus:ring-blue-500
focus:border-blue-500 dark:bg-gray-700 placeholder:text-black placeholder:font-bold dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
